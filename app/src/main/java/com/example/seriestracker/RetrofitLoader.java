...
public class RetrofitLoader extends AsyncTaskLoader<searchService.ResultWithDetail> {
    ...
    public RetrofitLoader(Context context, String title, String type) {
        super(context);
        mTitle = title;
        mType = type;
    }
    ...
    public searchService.ResultWithDetail loadInBackground() {
        ...
        try {
            searchService.Result result =  searchService.performSearch(mType,mTitle);
